...
- 블록 체인 기술이 활용된 비지니스 모델을 엿볼수 있다.
- IT용어에 대한 설명을 초보자도 알기 쉽게 기술 했다.
- 크리에이터(Creator) 직종의 사람들이 읽어보면 좋을듯 하다.

### 단점

- 기업 혹은 IT나 크리에이터 종사자가 아닌 일반 사람들이 공감하기에는 어렵다.
- 심도 있는 내용은 아니다.


## 관련 키워드

책에서 소개된 중요 용어들을 일상 용어로 풀어 보았다.
